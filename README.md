...
| 应用 | 版本 | 架构 | 最低 fnOS | 项目 |
| --- | --- | --- | --- | --- |
| MiAir Plus | 2.0.0-alpha.7（预览版） | 通用（x86_64 / ARM64） | 以组件兼容说明为准 | [miair-plus](https://github.com/BearHero520/miair-plus) |
...
MiAir Plus 提供小爱音箱 DLNA / AirPlay 音乐投送，以及支持上传、NAS 选曲、工作日和节假日规则的音乐闹钟。当前为预览版，具体音箱与发送端兼容性请查看项目说明。生命周期脚本需要 root，主服务以应用用户运行。
...
python scripts/refresh.py --miair-tag v2.0.0-alpha.7 --allow-miair-preview
```
